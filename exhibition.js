(async function () {
  ...
  const videoMap = {
    media_communication: { type: 'youtube', src: 'https://www.youtube.com/embed/FXuOBhUGMfU' },
    ...
    calculus_2: { type: 'youtube', src: 'https://www.youtube.com/embed/aivWo4ATnI8' },
    practical_statistics: { type: 'youtube', src: 'https://www.youtube.com/embed/cMj3e02_f8M' },
    ai_mathematics: { type: 'youtube', src: 'https://www.youtube.com/embed/FEtbfSytQIE' },
    economics: { type: 'youtube', src: 'https://www.youtube.com/embed/0_aBlJ_RJvA' },
    finance_and_economic_life: { type: 'youtube', src: 'https://www.youtube.com/embed/U0o6_S5Mj1Q' },
    climate_change_and_sustainability: { type: 'youtube', src: 'https://www.youtube.com/embed/uJsLmXteHK0' },
    urban_future_exploration: { type: 'youtube', src: 'https://www.youtube.com/embed/4IFBK5DkfiU' },
    east_asian_history_journey: { type: 'youtube', src: 'https://www.youtube.com/embed/5zNjdA033NE' },
    law_and_society: { type: 'youtube', src: 'https://www.youtube.com/embed/O204GKfvar0' },
    social_issues_exploration: { type: 'youtube', src: 'https://www.youtube.com/embed/mmNMLgJNF1Q' },
    ...
    travel_geography: { type: 'youtube', src: 'https://www.youtube.com/embed/Lun4bw30D4M' },
    exploring_modern_world_through_history: { type: 'youtube', src: 'https://www.youtube.com/embed/ZJoC4Ntdkhg' },
    ethical_issues_exploration: { type: 'youtube', src: 'https://www.youtube.com/embed/Fbtv0fu1NPE' },
    ethics_and_thought: { type: 'youtube', src: 'https://www.youtube.com/embed/bEDsa_jWdho' },
    humanities_and_ethics: { type: 'youtube', src: 'https://www.youtube.com/embed/Vci4WsQ0EvU' },
    politics: { type: 'youtube', src: 'https://www.youtube.com/embed/hfmDUANu5is' },
    korean_geography_exploration: { type: 'youtube', src: 'https://www.youtube.com/embed/wfxQhI2JavI' },
    changes_in_the_modern_world: { type: 'youtube', src: 'https://www.youtube.com/embed/uBLcKmsqJyQ' },
    modern_society_and_ethics: { type: 'youtube', src: 'https://www.youtube.com/embed/8vwP6cadisA' },
    history_and_culture_of_science: { type: 'youtube', src: 'https://www.youtube.com/embed/pSxwRTeGQD0' },
    climate_change_and_ecology: { type: 'youtube', src: 'https://www.youtube.com/embed/GciHwTXuT3I' },
    physics: { type: 'youtube', src: 'https://www.youtube.com/embed/DLCGl1_koZM' },
    matter_and_energy: { type: 'youtube', src: 'https://www.youtube.com/embed/TGCLDHltX14' },
    life_science: { type: 'youtube', src: 'https://www.youtube.com/embed/lz7aXRp6seA' },
    genetics: { type: 'youtube', src: 'https://www.youtube.com/embed/3Rgx4x7lU5A' },
    cells_and_metabolism: { type: 'youtube', src: 'https://www.youtube.com/embed/a_z8twlbKzE' },
    mechanics_and_energy: { type: 'youtube', src: 'https://www.youtube.com/embed/MRZI0pOkGso' },
    convergence_science_exploration: { type: 'youtube', src: 'https://www.youtube.com/embed/B_Pf_5_xGCc' },
    electromagnetism_and_quantum: { type: 'youtube', src: 'https://www.youtube.com/embed/-i6RPx2oAl0' },
    earth_science: { type: 'youtube', src: 'https://www.youtube.com/embed/3kgV_v-UzrM' },
    earth_system_science: { type: 'youtube', src: 'https://www.youtube.com/embed/_hJf1LUne_c' },
    planetary_and_space_science: { type: 'youtube', src: 'https://www.youtube.com/embed/HNLNsR3f9Xw' },
    chemistry: { type: 'youtube', src: 'https://www.youtube.com/embed/Kwhsvl59mBE' },
    world_of_chemical_reactions: { type: 'youtube', src: 'https://www.youtube.com/embed/iVXbps_JeOU' },
    exercise_and_health: { type: 'youtube', src: 'https://www.youtube.com/embed/w3Z0u99jbeA' },
    drawing: { type: 'youtube', src: 'https://www.youtube.com/embed/bgyxbYVyPFA' },
    art_appreciation_and_criticism: { type: 'youtube', src: 'https://www.youtube.com/embed/mr3mDRz9qfE' },
    art_and_media: { type: 'youtube', src: 'https://www.youtube.com/embed/mKbKL1mE_NY' },
    music_appreciation_and_criticism: { type: 'youtube', src: 'https://www.youtube.com/embed/DG7PSbT2KXQ' },
    music_performance_and_creation: { type: 'youtube', src: 'https://www.youtube.com/embed/TjEb3yIp2ss' },
    chorus_and_ensemble: { type: 'youtube', src: 'https://www.youtube.com/embed/-CknlxCeUA8' },
    technology_and_home_economics: { type: 'youtube', src: 'https://www.youtube.com/embed/KkZU175MDT0' },
    robotics_and_engineering: { type: 'youtube', src: 'https://www.youtube.com/embed/LDObTHzsbYU' },
    food_and_nutrition: { type: 'youtube', src: 'https://www.youtube.com/embed/X02aBQYh7MU' },
    child_development_and_parenting: { type: 'youtube', src: 'https://www.youtube.com/embed/uH4LFCa8_ms' },
    intellectual_property_basics: { type: 'youtube', src: 'https://www.youtube.com/embed/DOd2u5Lc8EA' },
    creative_engineering_design: { type: 'youtube', src: 'https://www.youtube.com/embed/EBoAHUQ1Ws8' },
    ai_basics: { type: 'youtube', src: 'https://www.youtube.com/embed/d41NqjBjicY' },
    information_technology: { type: 'youtube', src: 'https://www.youtube.com/embed/1b9ng0mpv78' },
    informatics_science: { type: 'youtube', src: 'https://www.youtube.com/embed/gIKWU5XApNs' },
    programming: { type: 'youtube', src: 'https://www.youtube.com/embed/liadb1OGY68' },
    language_life_and_hanja: { type: 'youtube', src: 'https://www.youtube.com/embed/efn9r3EtigI' },
    classical_chinese_reading: { type: 'youtube', src: 'https://www.youtube.com/embed/naP7ra1iHAc' },
    tourism_japanese: { type: 'youtube', src: 'https://www.youtube.com/embed/FINLzjayooA' },
    tourism_chinese: { type: 'youtube', src: 'https://www.youtube.com/embed/88kMPW0iQLk' },
    japanese_culture: { type: 'youtube', src: 'https://www.youtube.com/embed/vCtVRef19zU' },
    japanese: { type: 'youtube', src: 'https://www.youtube.com/embed/NpG5wNY7314' },
    japanese_conversation: { type: 'youtube', src: 'https://www.youtube.com/embed/9dZlaKg-XqY' },
    chinese_culture: { type: 'youtube', src: 'https://www.youtube.com/embed/-CpNJdwnmnc' },
    chinese: { type: 'youtube', src: 'https://www.youtube.com/embed/2hXbvtxNp6g' },
    chinese_conversation: { type: 'youtube', src: 'https://www.youtube.com/embed/w4NpIFohDaw' },
    understanding_education: { type: 'youtube', src: 'https://www.youtube.com/embed/70jNopze8N8' },
    critical_questions_and_creative_solutions: { type: 'youtube', src: 'https://www.youtube.com/embed/Fi3xvG_JA9w' },
    humans_and_psychology: { type: 'youtube', src: 'https://www.youtube.com/embed/qtLy-b-9j-M' },
    ai_ethics: { type: 'youtube', src: 'https://www.youtube.com/embed/o5npR6t0JSo' },
  };
